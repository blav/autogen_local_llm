...
def register_trelis_chat_completion_handler():
    @register_chat_completion_handler("trelis")
    def trelis_chat_completion_handler(
        llama: llama.Llama,
        ...
        **kwargs,  # type: ignore
        ...
        def _format_messages(messages: List[llama_types.ChatCompletionRequestMessage]) -> str:
            ...
            def _push_state(role: str) -> Dict[str, str]:
